"""
MDP Omega Response Receiver class.  Receive messages from a local
MDPOmegaConnection that is connected to Omega MDP.
"""
import logging
...
import omega_protocol.MarketDataMessage2_capnp as mdp_capnp
# pylint: enable=E0401
# pylint: enable=E0611
...
class MDPResponseReceiver(Thread):
    """
    ...
    message receiving from MDPOmegaConnection.
    ...
    def __init__(self,
                 ...
                 zmq_endpoint: str,
                 response_handler: MDPResponseHandler,
                 polling_timeout_milli: int = 1000,
                 name: str = 'MDPResponseHandler',
    ...
    def set_response_handler(self, response_handler: MDPResponseHandler):
        """
    ...
    def _handle_response(self,
        ...
        :param response_type: (str) The type of MarketDataMessage embedded in
        the response from Omega.
        :param response: (capnp._DynamicStructBuilder) One of the types under
            "TradeMessage.Response.body".
            See omega_protocol.MarketDataMessage2.capnp.
        """
    ...
    def _handle_binary_omega_message(self, binary_msg: bytes):
        ...
        """
        try:
            mdp_message = mdp_capnp.MarketDataMessage.from_bytes(binary_msg)
            response = mdp_message.type.response
