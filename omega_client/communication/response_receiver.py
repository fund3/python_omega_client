...
class ResponseReceiver(Thread):
    ...
    Attributes:
        ...
        ROUTER socket on the other side to identify the DEALER socket in this class. Optional since zmq DEALER socket generates a default identity.
    ...
    def _handle_response(self,
        ...
        :param response: (capnp._DynamicStructBuilder) One of the types under
            ...
            See trading_communication_protocol.TradeMessage.capnp.
        """
